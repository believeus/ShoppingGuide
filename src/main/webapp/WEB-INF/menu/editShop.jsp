		              ...
		              <tr>
						...
						<div class="brandImg">
							 <div id="preview_wrapper" style="display:inline-block;width:227px;height:179px; background-color:#CCC; margin-top: 1px;">    
							    ...
							    <div style="text-align:left;">   
							    <input id="businessLicensePhoto" type="file" name="businessLicensePhoto" style="width: 65px;" onchange="filename.value=this.value;onUploadImgChange(this,227,179,'preview','preview_fake','preview_size_fake');"/>  
		              ...
		              <tr>
						...
						<c:forEach var="path" items="${path}" varStatus="status">
							<div class="brandImg">
							    ...
							    <div style="text-align:left;">    
							    <%-- <input id="goodsImg${status.index+1}" type="file" name="goodsImg${status.index+1}" value="${path }" style="width: 65px;" onchange="filename${status.index+1}.value=this.value;Img('${path}');onUploadImgChange(this,227,179,'preview${status.index+1}','preview_fake${status.index+1}','preview_size_fake${status.index+1}');"/> --%>  
								...
								<div class="shanchu_moren" style="text-align: right; border-top: 1px dashed #E4E4E4; height: 49px; line-height: 40px; margin-right: 3px;">
