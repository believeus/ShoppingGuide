   	...
   	<div style="width:960px; padding-top:28px; margin-left:auto; margin-right:auto;">
       	...
       	<div style="float:right; margin-top:40px; font-size:16px; color:#056F6F; line-height:0px;">
           	...
           	<div class="setting">
           		...
           		<div style="width:103px;height:33px;line-height:33px;border-top:1px dotted #ccc;"><a href="" title="修改密码">修改密码</a></div>
           		<div style="width:103px;height:33px;line-height:33px;border-top:1px dotted #ccc;"><a href="" title="关联帐号">关联帐号</a></div>
           	</div>
        </div>
       </div>
</div>
