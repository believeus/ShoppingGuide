    ...
    m.fn.promptumenu = function(d) {
        ...
        return this.each(function() {
            ...
            if (b.data("promptumenu")) console.error("You are calling promptumenu for an element more than twice. Please have a look.");
                ...
                b.data("ppos", 0);
                e = {
                    width: "auto" == f.width ? b.width() : f.width,
                    height: "auto" == f.height ? b.height() : f.height,
                    padding: 0,
                    display: "block",
                    overflow: "hidden"
                };
                ...
                b.children("li").each(function() {
                    ...
                    "vertical" == f.direction ? (a.css({
                        top: Math.round(c.y * j - j / 2 - a.height() / 2 + (c.page - 1) * e.height),
                        left: Math.round(c.x * g - g / 2 - a.width() / 2)
                    }), a.find("img").bind("load", 
                    function() {
                        var b = a.data("layout");
                        a.css({
                            top: Math.round(b.y * j - 
                            j / 2 - a.height() / 2 + (b.page - 1) * e.height),
                            left: Math.round(b.x * g - g / 2 - a.width() / 2)
                        })
                    })) : (a.css({
                        top: Math.round(c.y * j - j / 2 - a.height() / 2),
                        left: Math.round(c.x * g - g / 2 - a.width() / 2 + (c.page - 1) * e.width)
                    }), a.find("img").bind("load", 
                    function() {
                        var b = a.data("layout");
                        a.css({
                            top: Math.round(b.y * j - j / 2 - a.height() / 2),
                            left: Math.round(b.x * g - g / 2 - a.width() / 2 + (b.page - 1) * e.width)
                        })
                    }))
                });
                h = c.page;
                ...
                if (1 < h && !0 == f.pages) {
                    ...
                    for (i = 2; i <= h; i++) s = s + "<a>Page " + i + "</a>";
                    b.parent("div.promptumenu_window").append('<div class="promptumenu_nav">' + s + "</div>");
                    b.parent("div.promptumenu_window").find(".promptumenu_nav a").bind("click.promptumenu", 
                    function() {
                ...
                function(a) {
                    ...
                    l = 0,
                    k = [];
                    m(document).bind("mousemove.promptumenu", 
                    function(a) {
                        a.preventDefault();
                        for (var e = {
                    ...
                    m(document).bind("mouseup.promptumenu", 
                    function(a) {
                        a.preventDefault();
                        m(document).unbind(".promptumenu");
                        var d = k[0],
                        g = (new Date).getTime() - d.time,
                        o = (a.pageX - d.x) / g,
                        a = (a.pageY - d.y) / g;
                        "vertical" == f.direction ? (d = c.top + l + a * f.inertia, d < -1 * e.height * (h - 1) ? d = -1 * e.height * (h - 1) : 0 < d && (d = 0), f.pages ? (o = Math.round( - d / e.height), 
                        n.go_to(o + 1, "inertia")) : b.animate({
                            top: d
                        },
                ...
                try {
                    ...
                    w = function(a) {
                        ...
                        "vertical" == f.direction ? (d = a.touches[0].pageY - u, b.css("-webkit-transform", "translate3d(0px, " + 
                        (p + d) + "px, 0px)")) : (k = a.touches[0].pageX - v, b.css("-webkit-transform", "translate3d(" + (p + k) + "px, 0px, 0px)"));
                        l.push(e)
                    },
                    t = function(a) {
                        a.preventDefault();
                        ...
                        "vertical" == f.direction ? (isNaN(c) && (c = 2), b.css({
                            "-webkit-transition-duration": Math.abs(3 * c * f.inertia) + "ms",
                            "-webkit-transition-timing-function": "ease-out"
                        }), a = p + d + c * f.inertia, a < -1 * e.height * 
                        (h - 1) ? a = -1 * e.height * (h - 1) : 0 < a && (a = 0), f.pages ? (a = Math.round( - a / e.height), n.go_to(a + 1, "inertia", !0)) : (b.css("-webkit-transform", "translate3d(0px, " + a + "px, 0px)"), b.data("ppos", a))) : (isNaN(a) && (a = 2), b.css({
                            "-webkit-transition-duration": Math.abs(3 * c * f.inertia) + "ms",
                            "-webkit-transition-timing-function": "ease-out"
                        }), a = p + k + a * f.inertia, a < -1 * e.width * (h - 1) ? a = -1 * e.width * (h - 1) : 0 < a && (a = 0), f.pages ? (a = Math.round( - a / e.width), n.go_to(a + 1, "inertia", !0)) : (b.css("-webkit-transform", "translate3d(" + a + "px, 0px, 0px)"), 
                        b.data("ppos", a)))
                    };
