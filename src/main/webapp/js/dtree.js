...
dTree.prototype.node = function(node, nodeId) {
	...
	if(node.pid == this.root.id){
		...
		/**组装checkbox开始*/
		checkboxSyntax = "<input type='checkbox' desc='" + node.cshow + "' name='" + node.cname + "' id='" + node.cname + "_" + node.id + "' value='" + node.id + "' onClick='javascript: " + this.obj + ".checkNode(" + node.id+","+node.pid+","+node._hc + ",this.checked);' ";
		//是否被选中
		if(node.cchecked)
